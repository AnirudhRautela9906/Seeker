...
import { FLUSH_REQUEST } from "../../redux/constants/userConstants";
...
const Navbar = () => {
  ...
  }, [location.pathname, isLoggedIn, Name, dispatch]);
  ...
  function loadJobsApplied() {
    toggleSlider();
    nav("/profile/jobsApplied");
  }
  function loadHome() {
    toggleSlider();
    nav("/profile");
            ...
            {isNotiOpen && (
              ...
              <div onClick={toggleSlider} className="open-slider-btn">
                <div className="boxProfile">
                  <div className="glow-text">{user.name}</div>
                </div>
              </div>
              ...
              <div className={`slider ${isOpen ? "open" : ""}`}>
                ...
                Account
                  ...
                  <button className="slider-button" onClick={loadJobsApplied}>
                    Jobs Applied
                  </button>
